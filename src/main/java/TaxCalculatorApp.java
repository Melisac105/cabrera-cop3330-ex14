...
public class TaxCalculatorApp {
    ...
    public static void main(String[] args) {
        ...
        String state = UsrInput.getState().toUpperCase();
        double tax = Calculations.calcTax(amount);
        double total = Calculations.calTotalResidents(amount, tax);
        Output.printOutput(state, amount, tax, total);
    }
